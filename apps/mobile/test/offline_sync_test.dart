...
void main() {
  test(
    'offline fallback sync preserves local id and original capture time',
    () async {
      ...
      final detection = PendingOfflineDetection(
        ...
        label: 'FMD',
        confidence: 0.8,
        modelVersion: 'image-offline-1.0.0',
        scores: const {'FMD': 0.8, 'healthy': 0.2},
      );
      ...
      expect(payload['nlp_evidence'], isNull);
