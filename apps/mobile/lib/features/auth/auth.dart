class AccountSession {
  ...
  AccountSession copyWith({String? name, String? address, String? jurisdictionId, bool? isActive}) => AccountSession(
        token: token,
        farmerId: farmerId,
        email: email,
        name: name ?? this.name,
...
class FarmerProfileDraft {
  FarmerProfileDraft({required this.name, required this.jurisdictionId, this.address});
  final String name;
  final String jurisdictionId;
  final String? address;
  Map<String, dynamic> toJson() => {'name': name, 'jurisdiction_id': jurisdictionId, if (address != null) 'address': address};
}
