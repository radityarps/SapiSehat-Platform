...
const routePermissions: Record<string, AgencyRole[]> = {
  '/agency/overview': ['admin', 'province_officer', 'district_officer', 'village_officer', 'viewer'],
  ...
  '/agency/users': ['admin'],
  '/agency/settings': ['admin', 'province_officer', 'district_officer', 'village_officer', 'viewer'],
};
